...
/** Controls automatic detection and repair of currency-unit price errors in
  * [[io.github.coinductive.yfinance4s.Charts.getChart]].
  *
  ...
  * correction - [[io.github.coinductive.yfinance4s.Charts.getDividends]] always reports Yahoo's raw amounts and can
  * therefore disagree. [[ChartResult.currency]] reports the effective price currency, standardised or not.
  */
