...
import io.github.coinductive.yfinance4s.models.{Ticker, YFinanceError}
import io.github.coinductive.yfinance4s.models.internal.YahooErrorBody

/** Maps Yahoo Finance's structured [[YahooErrorBody]] envelope onto the public [[YFinanceError]] hierarchy. Used by the
  * gateway after a `YahooResponse[_]` decodes to a
  * [[io.github.coinductive.yfinance4s.models.internal.YahooResponse.Failure]]
