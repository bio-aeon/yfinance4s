...
import io.github.coinductive.yfinance4s.{DividendFxConversion, FxRateSource, PriceRepair}
import io.github.coinductive.yfinance4s.DividendFxConversion.{FxLeg, FxPlan}
